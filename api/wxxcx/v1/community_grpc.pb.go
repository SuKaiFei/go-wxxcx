...
type CommunityClient interface {
	GetCommunityUserTitleList(ctx context.Context, in *CommonRequest, opts ...grpc.CallOption) (*GetCommunityUserTitleListReply, error)
...
func (c *communityClient) GetCommunityUserTitleList(ctx context.Context, in *CommonRequest, opts ...grpc.CallOption) (*GetCommunityUserTitleListReply, error) {
	out := new(GetCommunityUserTitleListReply)
	err := c.cc.Invoke(ctx, "/wxxcx.v1.community.Community/GetCommunityUserTitleList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCommunityServer) GetCommunityUserTitleList(context.Context, *CommonRequest) (*GetCommunityUserTitleListReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCommunityUserTitleList not implemented")
}
...
func _Community_GetCommunityUserTitleList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CommonRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommunityServer).GetCommunityUserTitleList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wxxcx.v1.community.Community/GetCommunityUserTitleList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommunityServer).GetCommunityUserTitleList(ctx, req.(*CommonRequest))
	}
...
var Community_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetCommunityUserTitleList",
			Handler:    _Community_GetCommunityUserTitleList_Handler,
		},
		{
